...
const ActivityDashboard: React.FC<IProps> = ({ submitting, activities, selectActivity, selectedActivity, editMode, setEditMode, setSelectedActivity, createActivity, editActivity, deleteActivity, target }) => {
    return (
        <Grid>
